                ...
                NavHost(
                    ...
                    composable("add") {
                        AddReminderScreen(
                            ...
                            onSave = { title, note, category, color, trigger, repeat, amount, counterparty, phone, financialType, attachmentUri, mileageTargetKm, location, bankName ->
                                val current = editingReminder
                                if (current != null) {
                                    viewModel.updateReminder(
                                        current.id, title, note, category, color, trigger, repeat,
                                        amount, counterparty, phone, financialType, attachmentUri, mileageTargetKm, location, bankName
                                    )
                                } else {
                                    viewModel.addReminder(
